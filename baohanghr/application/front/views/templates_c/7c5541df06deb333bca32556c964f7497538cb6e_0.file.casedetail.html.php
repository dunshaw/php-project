<?php
/* Smarty version 3.1.33, created on 2019-06-10 06:42:38
  from 'D:\baohanghr\application\front\views\templates\defualt\casedetail.html' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5cfdfbde4b1b81_60025677',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '7c5541df06deb333bca32556c964f7497538cb6e' => 
    array (
      0 => 'D:\\baohanghr\\application\\front\\views\\templates\\defualt\\casedetail.html',
      1 => 1560147437,
      2 => 'file',
    ),
  ),
...
function content_5cfdfbde4b1b81_60025677 (Smarty_Internal_Template $_smarty_tpl) {
?><!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
>
                    <a href="javascript:;"><?php echo $_smarty_tpl->tpl_vars['one']->value['biaoti'];?>
</a>
                </a>
            </a>
        </div>
        ...
        <div class="clearfix">
            ...
            <?php } else { ?>
            <a class="shang" href="/case/detail?id=<?php echo $_smarty_tpl->tpl_vars['after']->value['id'];?>
&sort_id=305">上一篇:<?php echo $_smarty_tpl->tpl_vars['after']->value['biaoti'];?>
</a>
            <?php }?>
            <?php if (empty($_smarty_tpl->tpl_vars['next']->value)) {?>
            <a class="xia" href="javascript:;">下一篇:没有了</a>
            <?php } else { ?>
            <a class="xia" href="/case/detail?id=<?php echo $_smarty_tpl->tpl_vars['next']->value['id'];?>
&sort_id=305">下一篇:<?php echo $_smarty_tpl->tpl_vars['next']->value['biaoti'];?>
</a>
            <?php }?>
        </div>
    </div>
