...
class Page{
	...
	private function getLast(){
		if ($this->current == $this->pagenum) {
			return  "<li><a href='javascript:;'>尾页</a></li>";
		} else {
			return  "<li><a href='{$this->url}{$this->pagenum}'>尾页</a></li>";
		}
	...
	private function getPrev(){
		if ($this->current == 1) {
			return  "<li><a href='javascript:;'>上一页</a></li>";
		} else {
			return  "<li><a href='{$this->url}".($this->current - 1)."'>上一页</a></li>";
		}
	...
	private function getNext(){
		if ($this->current == $this->pagenum ){
			return  "<li><a href='javascript:;'>下一页</a></li>";
		} else {
			return  "<li><a href='{$this->url}".($this->current+1)."'>下一页</a></li>";
		}
	...
	public function showPage(){
	    ...
	    if ($this->myde_i < 1)
		    ...
		    $str="";
		    $str.="<li><a href='javascript:;'>共{$this->getNum()}页</a></li>";
		    $str.=$this->getPrev();
		    ...
		    for ($i = $this->myde_i; $i <= $this->myde_en; $i++) {
		        if ($i == $this->current) {
		            $str.="<li><a href='" . $this->url.$i . "' title='第" . $i . "页' class='now'>$i</a></li>";
		        } else {
		            $str.="<li><a href='" . $this->url.$i . "' title='第" . $i . "页' >$i</a></li>";
		        }
		    }
		    if ($this->myde_en < $this->myde_page_count) {
		        $str.="<li><a>...</a></li>";
