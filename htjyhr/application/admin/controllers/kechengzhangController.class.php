<?php
//文章控制器
class kechengzhangController extends baseController{
	...
	public function indexAction(){
		...
		include CUR_VIEW_PATH ."Skechengzhang".DS."kechengzhang_list.html";
	}
	...
	public function addAction(){
	    ...
	    include CUR_VIEW_PATH ."Skechengzhang".DS."kechengzhang_add.html";
	}
	...
	public function editAction(){
	    ...
	    include CUR_VIEW_PATH ."Skechengzhang".DS."kechengzhang_edit.html";
	}
