...
//		define("CUR_TPL_PATH", $common->getHostDomain().DS.'application'.DS.PLATFORM.DS. "views" .DS);
        define("CUR_TPL_PATH", DS.'application'.DS.PLATFORM.DS. "views" .DS);
		...
		//定义404页面
		define("NOT_FOUND_PATH", 'http://'.$_SERVER['HTTP_HOST'].'/application/front/views/templates/defualt/public/404page.html');
...
//////////////// 多级 文件夹路由处理 dongdong //////////////////////////
        if (strpos($controller_name,'/')) {
            ...
            if (file_exists($file)) {
            	...
            	print_r(file_get_contents(NOT_FOUND_PATH));
            }
        }
////////////////多级 文件夹路由处理 dongdong //////////////////////////
       	if (file_exists($file)) {
